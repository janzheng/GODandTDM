...
!function($){
  ...
  $.fn.onepage_scroll = function(options){
    ...
    $.fn.moveUp = function() {
      ...
      console.log('BEFORE ::: current index: ' + index + ' next: ' + next.data("index"))

      // jan - adding in loop prevention here
      if(next.length < 1) {
        pos = 0;
          console.log('up: looping around');
        if(settings.loop) {
          pos = ((total - 1) * 100) * -1;
